...
<main id="primary" class="site-main front-page">
    ...
    <section class="front-page__hero text-weiss mb-5 mb-lg-b">
        <div class="container px-4 text-center py-4 py-md-a pt-lg-f pb-lg-d">

            <?php if ($subheadline) : ?>
                <h3 class="front-page__kicker fs-body secondary-font mb-3 text-weiss-75"><?php echo esc_html($subheadline); ?></h3>
            <?php endif; ?>

            <h1 class="front-page__headline display mb-5 mb-lg-c"><?php echo esc_html($headline ?: get_the_title()); ?></h1>
    ...
    <?php if ($testo_1) : ?>
        <section class="front-page__testo py-4 py-md-a text-center">
        ...
        <section class="front-page__interventi">
            <div class="container px-4">
                ...
                <div class="position-relative">
                    ...
                    <div class="pt-4 pt-md-b pb-4 border-top">
                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 gx-3 gx-md-4 gx-lg-c gy-5 gy-lg-d">
                        ...
                        <div class="front-page__interventi-cta dark text-center mt-5 mt-lg-b">
    ...
    <?php if ($testo_2) : ?>
        <section class="front-page__testo front-page__testo--cta pt-4 pt-md-a pb-4 text-center">
            <div class="container px-4">
